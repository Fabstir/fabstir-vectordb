...
mod batch_operations_tests {
    ...
    fn test_batch_insert_with_duplicates() {
        ...
        // Insert initial node
        index.insert(VectorId::from_string("a"), vec![1.0, 0.0]).unwrap();
    ...
    fn test_batch_insert_progress_callback() {
        ...
        let results = index.batch_insert_with_progress(batch, progress_callback).unwrap();
