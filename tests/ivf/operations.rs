...
mod batch_operations_tests {
    ...
    fn test_batch_insert_with_failures() {
        ...
        index.insert(VectorId::from_string("a"), vec![0.1, 0.1]).unwrap();
    ...
    fn test_batch_search() {
        ...
        for i in 0..10 {
            ...
            index.insert(id, vec![angle.cos() * 3.0, angle.sin() * 3.0]).unwrap();
        }
    ...
    fn test_optimize_clusters() {
        ...
        for i in 0..30 {
            ...
            if i < 25 {
                ...
                index.insert(id, vec![i as f32 * 0.1, i as f32 * 0.1]).unwrap();
            } else {
...
mod statistics_tests {
    ...
    fn test_search_quality_metrics() {
        ...
        // Test search quality
        let test_queries: Vec<Vec<f32>> = (0..10)
...
mod maintenance_tests {
    ...
    fn test_export_import_centroids() {
        ...
        new_index.insert(VectorId::from_string("test"), vec![1.0, 1.0]).unwrap();
    }
}
